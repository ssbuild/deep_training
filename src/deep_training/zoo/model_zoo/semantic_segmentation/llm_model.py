...
class TransformerForSemanticSegmentation(TransformerBase):
    def __init__(self, *args,model_class=None,**kwargs):
        super(TransformerForSemanticSegmentation, self).__init__(*args,**kwargs)
...
class MyTransformer(TransformerForSemanticSegmentation, ModelWeightMixin,BaseModelWrapper, with_pl=True):
    @hf_decorator
