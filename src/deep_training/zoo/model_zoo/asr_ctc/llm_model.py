...
class TransformerForCTC(TransformerBase):
    def __init__(self, *args,model_class=None,**kwargs):
        super(TransformerForCTC, self).__init__(*args,**kwargs)
        self.set_model(self.from_pretrained(model_class or AutoModelForCTC,*args,**kwargs))
...
class MyTransformer(TransformerForCTC, ModelWeightMixin,BaseModelWrapper, with_pl=True):
    @hf_decorator
