...
class ChatGLMForConditionalGeneration(ChatGLMPreTrainedModel):
    ...
    @torch.no_grad()
    def stream_chat(self, tokenizer, query: str, history: List[Tuple[str, str]] = None, logits_processor=None,
                    **kwargs):
        if history is None:
            history = []
        if logits_processor is None:
...
class TransformerChatGlmLMHeadModel(TransformerBase):
    def __init__(self, *args, **kwargs):
        super(TransformerChatGlmLMHeadModel, self).__init__(*args, **kwargs)
        self.set_model(self.from_pretrained(ChatGLMForConditionalGeneration, *args, **kwargs))